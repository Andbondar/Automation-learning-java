...
public class StringGenerator {
    ...
    public static class NameGenerator {
        ...
        public String getName() {
            return firstCharUppercase(getNameByInstructions((String) getRandomElementFrom(nameInstructions)));
        }
        ...
        private String getNameByInstructions(String nameInstructions) {
            ...
            for (int i = 0; i < l; i++) { char x = nameInstructions.charAt(0);
                switch (x) {
                    case 'v': name += getRandomElementFrom(vocals); break;
                    case 'c': name += getRandomElementFrom(startConsonants); break;
                    case 'd': name += getRandomElementFrom(endConsonants); break;
                }
        ...
        private Object getRandomElementFrom(List v) {
